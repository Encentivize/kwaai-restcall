    ...
    var service={
        ...
        callRestService:
            function(options,callback){
                ...
                var baseUrl="";
                if (this.globalOptions.baseUrl){baseUrl=this.globalOptions.baseUrl;}
                if (options.baseUrl){baseUrl=options.baseUrl}
                copiedOptions.baseUrl=baseUrl;

                var headers={}
                if (this.globalOptions.headers){headers=deepcopy(this.globalOptions.headers);}
                if (options.headers){
                ...
                var auth=null;
                if (this.globalOptions.auth){auth=deepcopy(this.globalOptions.auth);}
